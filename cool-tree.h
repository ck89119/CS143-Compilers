...
public:
   ...
   virtual Symbol Name() = 0;
   virtual void CheckFeatureType() = 0;
   virtual bool IsMethod() = 0;
   virtual void AddMethodToTable(Class_ cls) = 0;
   virtual void AddAttributeToTable() = 0;
...
public:
   ...
   Symbol ReturnType() { return return_type; }
   Expression Expr() { return expr; }
   bool IsMethod() { return true; }
   void AddMethodToTable(Class_ cls);
